...
const translations = {
  'en-US': {
    ...
    'cases.create_failed': 'Failed to create case',
    ...
    // Scanner Hub
    'scanner_hub.title': 'Integration Hub',
    'scanner_hub.subtitle': 'OAST payload delivery & external tool integration',
    'scanner_hub.recent_runs': 'Recent Runs',
    'scanner_hub.no_runs': 'No Runs Yet',
    'scanner_hub.select_scanner': 'Select Adapter',
    'scanner_hub.select_scanner_placeholder': 'Select Adapter',
    ...
    'scanner_hub.no_case_hint': 'No Case available. Create a Case first to use Integration Hub.',
    ...
    'scanner_hub.generate_run': 'Generate Run',
    ...
    'scanner_hub.load_adapters_failed': 'Failed to load adapters',
    'scanner_hub.create_payload_failed': 'Failed to create Payload',
    'scanner_hub.create_run_failed': 'Failed to create Run',
    'scanner_hub.search_engines': 'Search Engines',
    'scanner_hub.search_placeholder': 'Search query (e.g. title:nginx)',
    'scanner_hub.search': 'Search',
    'scanner_hub.search_failed': 'Search failed',
    'scanner_hub.found_results': 'Found ',
    'scanner_hub.port': 'Port',
    'scanner_hub.protocol': 'Protocol',
    'scanner_hub.hostname': 'Hostname',
    'scanner_hub.action': 'Action',
    'scanner_hub.create_run': 'Create Run',
    'scanner_hub.selected': ' selected',
    'scanner_hub.create_selected_runs': 'Create Runs for Selected',
    'scanner_hub.create_from_search_failed': 'Failed to create Runs from search results',
    'scanner_hub.no_results': 'No results found',
    'scanner_hub.confirm_create_title': 'Confirm Create Runs',
    'scanner_hub.confirm_create_desc': 'Runs will be created for the following targets:',
  ...
  'zh-CN': {
    ...
    'nav.attack-chains': '攻击链',
    'nav.canary': '金丝雀令牌',
    'nav.rebinding': '重绑定实验室',
    'nav.listeners': '协议监听',
    'nav.retention': '数据保留',
    'nav.workflow': '工作流',
    'nav.scanner-hub': '集成中心',
    'nav.marketplace': '市场',
    'nav.settings': '设置',
    'nav.users': '用户',
    'nav.apikeys': 'API 密钥',
    ...
    // Scanner Hub
    'scanner_hub.title': '集成中心',
    'scanner_hub.subtitle': 'OAST Payload 投递与外部工具集成',
    'scanner_hub.recent_runs': '最近的运行',
    'scanner_hub.no_runs': '暂无运行记录',
    'scanner_hub.select_scanner': '选择适配器',
    'scanner_hub.select_scanner_placeholder': '选择适配器',
    ...
    'scanner_hub.no_case_hint': '没有可选择的 Case，需要先创建 Case 才能使用集成中心。',
    ...
    'scanner_hub.generate_run': '生成 Run',
    ...
    'scanner_hub.load_adapters_failed': '加载适配器列表失败',
    'scanner_hub.create_payload_failed': '创建 Payload 失败',
    'scanner_hub.create_run_failed': '创建 Run 失败',
    'scanner_hub.search_engines': '搜索引擎搜索',
    'scanner_hub.search_placeholder': '输入搜索语句 (如: title:nginx)',
    'scanner_hub.search': '搜索',
    'scanner_hub.search_failed': '搜索失败',
    'scanner_hub.found_results': '找到 ',
    'scanner_hub.port': '端口',
    'scanner_hub.protocol': '协议',
    'scanner_hub.hostname': '主机名',
    'scanner_hub.action': '操作',
    'scanner_hub.create_run': '创建 Run',
    'scanner_hub.selected': '条已选择',
    'scanner_hub.create_selected_runs': '为选中项创建 Run',
    'scanner_hub.create_from_search_failed': '从搜索结果创建 Run 失败',
    'scanner_hub.no_results': '未找到匹配的结果',
    'scanner_hub.confirm_create_title': '确认创建 Run',
    'scanner_hub.confirm_create_desc': '将为以下目标创建 Run：',
