...
- Name: cases.spec.ts >> Cases Board >> should navigate to case detail on click
- Location: e2e/cases.spec.ts:56:7
...
Call log:
  - waiting for locator('li').filter({ hasText: 'Test Case' }).first()
