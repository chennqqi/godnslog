...
- Name: cases.spec.ts >> New Payload >> should display template selection
- Location: e2e/cases.spec.ts:226:7
...
Locator: locator('text=SSRF HTTP').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=SSRF HTTP').first()
