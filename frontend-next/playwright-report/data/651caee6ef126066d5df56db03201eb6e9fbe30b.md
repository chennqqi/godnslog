...
- Name: cases.spec.ts >> Payload Detail >> should display quick actions
- Location: e2e/cases.spec.ts:317:7
...
Locator: locator('text=快速操作').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=快速操作').first()
