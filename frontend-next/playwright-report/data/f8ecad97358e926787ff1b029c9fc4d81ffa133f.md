...
- Name: cases.spec.ts >> New Payload >> should display step indicator
- Location: e2e/cases.spec.ts:219:7
...
Locator: locator('text=Choose a template').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Choose a template').first()
