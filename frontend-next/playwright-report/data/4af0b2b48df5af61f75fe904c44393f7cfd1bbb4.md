...
- Name: cases.spec.ts >> Payload Detail >> should display associated case
- Location: e2e/cases.spec.ts:307:7
...
Locator: locator('text=关联 Case').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=关联 Case').first()
