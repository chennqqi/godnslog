...
- Name: cases.spec.ts >> Case Detail >> should display payloads list
- Location: e2e/cases.spec.ts:153:7
...
Locator: locator('text=Payloads').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Payloads').first()
