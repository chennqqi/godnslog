...
- Name: cases.spec.ts >> Payload Detail >> should display token
- Location: e2e/cases.spec.ts:299:7
...
Locator: locator('text=gdl_abc123').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=gdl_abc123').first()
